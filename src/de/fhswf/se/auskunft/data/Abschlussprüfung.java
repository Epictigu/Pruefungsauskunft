...
public class Abschlussprüfung extends Modul{
	
	public Abschlussprüfung(List<Float> notenListe) {
		this.notenListe = notenListe;
		this.name = "Abschlussprüfung";
	...
	protected void update() {
		AbschlussSQL.updateAbschluss(this);
	}

	@Override
	protected void updateName(String oldName) {
		System.err.println("Ungültiger Zugriff! UpdateName-Funktion steht nicht zur Verfügung für die Abschlussprüfung.");
	}
	...
	public Integer getEcts() {
		return Constants.ECTS_ABSCHLUSS;
	}
